...
import "./interfaces/IAVALabVote.sol";
import "./Ownable.sol";


// AVALab Token with bridge token logic and non-transferable non-valuable Vote token

//Bridge
// it can only be closed.
// it can only be set once
// Bridge Setter is set during deployement to add bridge address after deployement, //Bridge needs AVALab to be deployed prior
...
//Mints VoteTokens 1:1 AVALab TOKENS


contract AVALabToken is ERC20("AVALab Token", "AVAL"), Ownable {
    IAVALabVote public voteToken;
    ...
    constructor(IAVALabVote _voteAddress) public{
        devAddr = msg.sender;
